% PRODUCE_PLOTS2     Produce plots for GM2PHASEPLANE
%
...
%     colorbar; set(gca, 'YTickLabel', flipud(get(gca, 'YTickLabel')));   % Flip beta labels
    ...
    figure(g); clf; colormap([0 0 0])
    Cnum = 10;      % # of contour lines
    [CL, HL] = contour(delta, fliplr(beta), flipud(eval(['10*log10(mean_TNMSE_' suffix{g} ')'])), ...
        [-30:1:0]);
    clabel(CL, HL, 'fontsize', 18)
