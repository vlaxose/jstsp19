% GM2PHASE_TEST        A test of EMturboGAMP for the MMV signal model,
...
%
% The noise will be a binary Gaussian mixture with small and large variance
% components.
%
% The signal coefficients will be marginally
% Bernoulli/binary-Gaussian-mixture.
%
%
% SYNTAX:
% GM2phase_test(N, T, alpha, CommonA, SNRmdB, N_trials, fid)
%
% INPUTS:
...
function GM2phase_test(N, T, Alpha, CommonA, SNRmdB, N_trials, fid)
...
Theta = 1;            	% Mean of active coefficients                   [dflt=0]
Sigma2 = 0.25;       	% Steady-state amplitude variance               [dflt=1]
eps = 1e-6;             % "Squelch" parameter for inactives             [dflt=1e-6]
PI = 0.10;           	% Prob. of drawing from large variance          [dflt=0.10]
NUratio = 1000;       	% Ratio of big-to-small noise variance          [dflt=1000]
...
savefile = [datestr(now, 'ddmmmyyyy_HHMMSSFFF') '_GM2phase_test_N_' ...
...
path(path, '../../../../../../SparseSolvers/gampmatlab/trunk/code/turboGAMP/ClassDefs')
path(path, '../../../ClassDefs')
path(path, '../../../')
...
%             D = 1;      % 1 mixture component
            ...
            AmplitudeObj = GaussMarkov('Alpha', Alpha*ones(1,1,D), 'learn_alpha', ...
                'true', 'dim', 'row', 'init_params', 'false');
            
            % Create Noise class object for AWGN
            NoiseObj = GaussMixNoise('PI', PI, 'NUratio', NUratio, 'learn_pi', ...
            'scalar', 'learn_nu0', 'scalar', 'learn_nuratio', 'scalar');
            ...
            TurboObj = TurboOpt('Signal', SignalObj, 'Observation', NoiseObj, ...
...
%                 'false', 'learn_active_var', 'false', 'init_params', 'false');   
            ...
            GenieObservationObj = GaussMixNoise('PI', PI, 'NUratio', NUratio, ...
                'NU0', NU0, 'learn_pi', 'false', 'learn_nu0', 'false', ...
                'learn_nuratio', 'false');
            
            % Place signal model objects into TurboOpt container
            GenieTurboObj = TurboOpt('Signal', GenieSignalObj, 'Observation', ...
                GenieObservationObj, 'SupportStruct', GenieSupportObj, ...
...
%                 'scalar', 'init_params', 'true');
            ...
            % Create Observation class object for AWGN
            NaiveObservationObj = GaussMixNoise('PI', PI, 'NUratio', NUratio, ...
                'NU0', NU0, 'learn_pi', 'scalar', 'learn_nu0', 'scalar', ...
                'learn_nuratio', 'scalar');
            NaiveTurboObj = TurboOpt('Signal', NaiveSignalObj, 'Observation', ...
                NaiveObservationObj, 'SupportStruct', NoSupportStruct(), ...
...
%                 'false', 'learn_active_var', 'false', 'init_params', 'false');   
            ...
            % Create Observation class object for AWGN
            NoEMObservationObj = GaussMixNoise('PI', PI, 'NUratio', NUratio, ...
                'NU0', NU0, 'learn_pi', 'false', 'learn_nu0', 'false', ...
                'learn_nuratio', 'false');
            
            % Place signal model objects into TurboOpt container
            NoEMTurboObj = TurboOpt('Signal', NoEMSignalObj, 'Observation', ...
                NoEMObservationObj, 'SupportStruct', NoEMSupportObj, ...
