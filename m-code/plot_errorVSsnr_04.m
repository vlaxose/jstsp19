...
legend({'OMP [11]', 'VAMP [19]', 'TSSR [15]', 'Proposed'}, 'FontSize', 12, 'Location', 'Best');

xlabel('SNR (dB)');
ylabel('NMSE (dB)')
grid on;set(gca,'FontSize',12);

savefig(strcat('results/errorVSsnr_04.fig'))
save('results/errorVSsnr_04.mat')
